...
REQUIRED_PATHS = [
    "README.md",
    "lightweighting/README.md",
    "lightweighting/requirements.txt",
    "lightweighting/configs/demo_cpu.json",
    "lightweighting/configs/vehicle_gpu_8g.json",
    "lightweighting/data/sample_corpus.txt",
    "lightweighting/scripts/run_from_config.py",
    "lightweighting/scripts/run_resource_report.py",
    "lightweighting/scripts/run_all_lightweighting_experiments.py",
    "lightweighting/src/chapter2_lightweighting/pipeline.py",
    "lightweighting/src/chapter2_lightweighting/pruning.py",
    "lightweighting/src/chapter2_lightweighting/distillation.py",
    "lightweighting/src/chapter2_lightweighting/config_loader.py",
    "lightweighting/src/chapter2_lightweighting/metrics.py",
    "lightweighting/src/chapter2_lightweighting/reporting.py",
    "lightweighting/experiments/chapter4_lightweighting/run_convergence_experiment.py",
    "lightweighting/experiments/chapter4_lightweighting/run_table_4_3_hardware_constraints.py",
    ...
    "experiments/chapter4_lightweighting/101.py",
    "experiments/chapter4_lightweighting/102.py",
    "experiments/chapter4_lightweighting/知识蒸馏对比.py",
    "experiments/chapter4_lightweighting/收敛.py",
    "experiments/chapter4_lightweighting/run_convergence_experiment.py",
    "experiments/chapter4_lightweighting/run_pruning_accuracy_experiment.py",
    "experiments/chapter4_lightweighting/run_pruning_ppl_experiment.py",
    "experiments/chapter4_lightweighting/run_distillation_comparison_experiment.py",
    "experiments/chapter4_lightweighting/table_data.py",
    "experiments/chapter4_lightweighting/run_table_4_3_hardware_constraints.py",
    "experiments/chapter4_lightweighting/run_table_4_4_ablation.py",
    "experiments/chapter4_lightweighting/run_table_4_5_kvret.py",
    "experiments/chapter4_lightweighting/requirements.txt",
    "experiments/chapter4_lightweighting/README.md",
